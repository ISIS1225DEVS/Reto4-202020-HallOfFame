...
def top(map):
    return model.theTop(map)

def noTop(map,mayor):
    return model.theNoTop(map,mayor)

def stationNear(map,lat1,lon1):
    return model.stationNear(map,lat1,lon1)

def theBestRoute(graph,station1,station2):
    return model.theBestRoute(graph, station1, station2)
def FindCycles(analyzer,startvertex,time1,time2):
    return model.circularroutes(analyzer,startvertex,time1,time2)

def getmincostpathage(analyzer,age):
    return model.getmincostpathage(analyzer,age)
